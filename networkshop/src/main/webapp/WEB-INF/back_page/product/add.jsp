...
function uploadPic(){
	...
	var options = {
		...
		success : function(data){
			...
			//url
			//path
			$("#allImgUrl").attr("src",data.imageUrl);
	...
	$("#tabs a").each(function(){
		...
		$(this).click(function(){
			...
			if(ref == '#tab_2'){
				...
				fck.Height = 400 ;
				fck.Config["ImageUploadURL"] = "/control/upload/uploadFck.do";
				fck.ReplaceTextarea();
			}
		});
	});
			...
			<tbody id="tab_1">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						材质:</td><td width="80%" class="pn-fcontent">
							<c:forEach items="${allFeature}" var="feature">
								<input type="checkbox" value="${feature.featureId}" name="feature"/>${feature.name}
							</c:forEach>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						颜色:</td><td width="80%" class="pn-fcontent">
							<c:forEach items="${allColor}" var="color">
								<input type="checkbox" value="${color.colorId}" name="color"/>${color.name}
							</c:forEach>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input type="file" onchange="uploadPic()" name ="image"/>
					</td>
				</tr>
			</tbody>
