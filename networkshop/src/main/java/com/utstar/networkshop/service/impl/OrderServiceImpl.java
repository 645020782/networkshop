...
import com.utstar.networkshop.dao.OrderDao;
...
public class OrderServiceImpl implements OrderService {
	...
	public Pagination getOrderListWithPage(Order order) {
		...
		p.setCurrentPage(order.getCurrentPage());
		p.setPageSize(order.getPageSize());
		p.setRecordTotal(orderDao.getOrderListCount(order));
		p.setRows(orderDao.getOrderListWithPage(order));
		return p;
	}
