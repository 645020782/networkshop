...
import com.utstar.networkshop.dao.CityDao;
...
public class CityServiceImpl implements CityService {
	...
	@Transactional(readOnly = true)
	public Pagination getCityListWithPage(City city) {
		Pagination p = new Pagination();
		p.setCurrentPage(city.getCurrentPage());
		p.setPageSize(city.getPageSize());
		p.setRecordTotal(cityDao.getCityListCount(city));
		p.setRows(cityDao.getCityListWithPage(city));
		return p;
	}
